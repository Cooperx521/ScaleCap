...
def process_question(line, ans_file, cap_file, second_filter):
    ...
    image_file = line["meta_info"]["image_path"].split("/")[-1]
...
if __name__ == "__main__":
    ...
    image_folder = "/path/MMStar"
    answers_file = f"./eval/mmstar/answers/{model_name}.jsonl"
    caption_file = f"./eval/mmstar/captions/{model_name}.jsonl"
    second_filter = args.second_filter

    questions = dataset["val"]
