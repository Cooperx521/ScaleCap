...
if __name__ == "__main__":
    ...
    data_path = "./eval/mm-vet/llava-mm-vet.jsonl"
    image_folder = "/path/mm-vet/images"
    answers_file = f"./eval/mm-vet/answers/{model_name}.jsonl"
    caption_file = f"./eval/mm-vet/captions/{model_name}.jsonl"
    second_filter = args.second_filter

    questions = [json.loads(q) for q in open(data_path, "r")]
